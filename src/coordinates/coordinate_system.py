...
class CoordinateSystem:
    ...
    @staticmethod
    def normalize(coords: Union[float, List[float], torch.Tensor], 
                 dimensions: Union[int, Tuple[int, ...]], 
                 input_space: str = PIXEL) -> Union[float, List[float], torch.Tensor]:
        """
    ...
    @staticmethod
    def denormalize(coords: Union[float, List[float], torch.Tensor], 
                   dimensions: Union[int, Tuple[int, ...]], 
                   output_space: str = PIXEL) -> Union[float, List[float], torch.Tensor]:
        """
    ...
    @staticmethod
    def convert(coords: Union[float, List[float], torch.Tensor],
               dimensions: Union[int, Tuple[int, ...]], 
               from_space: str, 
               to_space: str) -> Union[float, List[float], torch.Tensor]:
        """
...
class PointList:
    ...
    def from_coordinates(cls,
                       ...
                       space: str = CoordinateSystem.NORMALIZED) -> 'PointList':
        """
