...
class ImageEmbedder:
    ...
    def _initialize_detector(self, l2_normalize: bool, quantize: bool, running_mode: str, delegate: str):  # Added running_mode
    ...
    def embed(
        ...
        delegate: str = "cpu",
    ) -> List[List[ImageEmbedderResult]]:  # Added running_mode
