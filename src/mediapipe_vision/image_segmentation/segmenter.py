...
class ImageSegmenter:
    ...
    def _initialize_segmenter(self, output_confidence_masks: bool, output_category_mask: bool, running_mode: str, delegate_mode="cpu"):
        ...
        if self._detector_instance is None or self.current_config != new_config:
            ...
            logger.info(
                f"Initializing ImageSegmenter: model='{self.model_path}', conf_mask={output_confidence_masks}, cat_mask={output_category_mask}, mode={running_mode}, delegate={delegate_mode}"
            )
        ...
        for i in range(batch_size):
            ...
            try:
                ...
                if output_confidence_masks:
                    batch_results_confidence.append(None)
                if output_category_mask:
                    batch_results_category.append(None)
