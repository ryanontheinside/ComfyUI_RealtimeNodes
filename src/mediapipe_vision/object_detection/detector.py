...
class ObjectDetector:
    ...
    def _initialize_detector(self, score_threshold: float, max_results: int, running_mode: str, delegate: str):  # Added running_mode
    ...
    def detect(
        ...
        delegate: str = "cpu",
    ) -> List[List[ObjectDetectionResult]]:  # Added running_mode
