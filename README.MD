...
### Particle Effects 🌟
- **TemporalParticleDepthNode**: Generates a temporally consistent particle depth map with a controllable origin point. Can be linked to hand tracking for interactive particle effects.
